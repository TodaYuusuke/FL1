...
Bomber::Bomber(IWorld* world, int ID, const EnemyData& data) {
...
const int Bomber::GetBTRunningNodeID() const {
...
void Bomber::AnimManagerUpdate()
{
	animManager_->Update();
}

void Bomber::PlayAttackAnim(const int weaponSide)
{
	// 武器の情報取得
